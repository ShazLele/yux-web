...
Package.onUse(function (api) {
  ...
  var assets = [
    'build/fonts/roboto/Roboto-Bold.ttf',
    'build/fonts/roboto/Roboto-Bold.woff',
    'build/fonts/roboto/Roboto-Bold.woff2',
    'build/fonts/roboto/Roboto-Light.ttf',
    'build/fonts/roboto/Roboto-Light.woff',
    'build/fonts/roboto/Roboto-Light.woff2',
    'build/fonts/roboto/Roboto-Medium.ttf',
    'build/fonts/roboto/Roboto-Medium.woff',
    'build/fonts/roboto/Roboto-Medium.woff2',
    'build/fonts/roboto/Roboto-Regular.ttf',
    'build/fonts/roboto/Roboto-Regular.woff',
    'build/fonts/roboto/Roboto-Regular.woff2',
    'build/fonts/roboto/Roboto-Thin.ttf',
    'build/fonts/roboto/Roboto-Thin.woff',
    'build/fonts/roboto/Roboto-Thin.woff2',
  ];

  addAssets(api, assets);

  api.addFiles([
    'build/js/materialize.js'
  ], 'client');
